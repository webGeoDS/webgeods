...
loadExampleButton = {
  ...
  button.onclick = async () => {
    ...
    try {
      ...
      mutable uploadStatus = "⌛ Inspecting...";
      await autoInspect();
      mutable uploadStatus = "✓ example data loaded — pick a target CRS to convert and download.";
    } finally {
      mutable uploadBusy = false;
    }
  };
...
controlPanelRow = WebGeoDS.controlPanelRow([uploadControl, loadExampleButton, resetMapButton])
```
