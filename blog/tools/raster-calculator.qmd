...
with rasterio.open(path) as src:
    ...
    # Pixels are base64-encoded as float32 bytes, not handed to JS as
    # a numpy array directly: that sidesteps any ambiguity about how
    # Pyodide would convert a 2D ndarray on its own.
