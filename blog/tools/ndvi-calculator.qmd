...
with rasterio.open(path) as src:
    ...
    # Pixels are base64-encoded here so this raw binary array can be
    # read back as plain text on the JavaScript side.
